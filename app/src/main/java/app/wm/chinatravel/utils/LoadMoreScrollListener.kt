...
abstract class LoadMoreScrollListener: RecyclerView.OnScrollListener() {
    ...
    fun LoadMoreScrollListener(layoutManager: LinearLayoutManager):  {
        this.mLayoutManager = layoutManager
    }

    fun LoadMoreScrollListener(layoutManager: GridLayoutManager):  {
        this.mLayoutManager = layoutManager
        visibleThreshold = visibleThreshold * layoutManager.spanCount
    }

    fun LoadMoreScrollListener(layoutManager: StaggeredGridLayoutManager): ??? {
        this.mLayoutManager = layoutManager
        visibleThreshold = visibleThreshold * layoutManager.spanCount
    }
